package mypackage;
	...
	public class welcomescreen {
		...
		public static void main(String[] args) {
			...
			File directory = new File("C:\\Users\\hp\\OneDrive\\Desktop\\simplilearn\\File creation project");
			...
			do {
				...
				case 1:
					...
					try {
						File file = new File("C:\\Users\\hp\\OneDrive\\Desktop\\simplilearn\\File creation project" + filename + ".txt");
				...
				case 3:
					...
					File directory_delete = new File("C:\\Users\\hp\\OneDrive\\Desktop\\simplilearn\\File creation project");
					...
					if (flist_delete == null) {
						...
						for (int i = 0; i < flist_delete.length; i++) {
							...
							if (delete_filename.equalsIgnoreCase(filename)) {
								...
								File file = new File(
										"C:\\Users\\hp\\OneDrive\\Desktop\\simplilearn\\File creation project" + delete_filename);
								if (file.delete()) {
				...
				case 4:
					...
					File directory_search = new File("C:\\Users\\hp\\OneDrive\\Desktop\\simplilearn\\File creation project");
		...
		private static void listOfFiles() {
			...
			File folder = new File("C:\\Users\\hp\\OneDrive\\Desktop\\simplilearn\\File creation project");
